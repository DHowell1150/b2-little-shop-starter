...
RSpec.describe Customer, type: :model do
  ...
  describe 'class methods' do
    before(:each) do
      ...
      @invoice_1 = Invoice.create!(customer_id: @customer.id, status: 2) #completed
      ...
      @item_1 = Item.create!(name: "Shampoo", description: "This washes your hair", unit_price: 10, merchant_id: @merchant1.id, status: 1) # enabled

      @ii_1 = InvoiceItem.create!(invoice_id: @invoice_1.id, item_id: @item_1.id, quantity: 9, unit_price: 10, status: 0, created_at: "2012-03-27 14:54:09") #status pending
      @ii_2 = InvoiceItem.create!(invoice_id: @invoice_1a.id, item_id: @item_1.id, quantity: 8, unit_price: 10, status: 0, created_at: "2012-03-29 14:54:09")
      @ii_3 = InvoiceItem.create!(invoice_id: @invoice_3.id, item_id: @item_1.id, quantity: 8, unit_price: 10, status: 0, created_at: "2012-03-27 14:54:09")
      @ii_4 = InvoiceItem.create!(invoice_id: @invoice_4.id, item_id: @item_1.id, quantity: 7, unit_price: 10, status: 0, created_at: "2012-03-29 14:54:09")
      @ii_5 = InvoiceItem.create!(invoice_id: @invoice_5.id, item_id: @item_1.id, quantity: 6, unit_price: 10, status: 0, created_at: "2012-03-27 14:54:09")
      @ii_6 = InvoiceItem.create!(invoice_id: @invoice_6.id, item_id: @item_1.id, quantity: 5, unit_price: 10, status: 0, created_at: "2012-03-29 14:54:09")
      @ii_7 = InvoiceItem.create!(invoice_id: @invoice_1.id, item_id: @item_1.id, quantity: 1, unit_price: 10, status: 0, created_at: "2012-03-27 14:54:09")
      ...
      @transaction1 = Transaction.create!(credit_card_number: 203942, result: 1, invoice_id: @invoice_1.id) #result success
