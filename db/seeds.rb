...
@coupon3 = @merchant2.coupons.create!(name: "Twenty Five Percent", status: 1, code: "25%OFF", amount: 25.0, coupon_type: "%")
@coupon4 = @merchant2.coupons.create!(name: "Twenty Percent", status: 1, code: "20%OFF", amount: 20.0, coupon_type: "%")

#Status: deactivated
@coupon5 = @merchant1.coupons.create!(name: "Five dollars", code: "5OFF", amount: 5, coupon_type: "dollars") 
@coupon6 = @merchant2.coupons.create!(name: "Twenty Dollars off", code: "20OFF", amount: 20, coupon_type: "dollars") 
